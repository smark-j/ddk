...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h4 class="lined-heading"><span><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></span></a></h4>
	...
	<section class="shipping-calculator-form">
		...
		<p class="update-totals-button"><button type="submit" name="calc_shipping" value="1" class="button"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
