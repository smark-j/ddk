...
<?php if ( comments_open() ) : ?><div id="reviews"><?php
	...
	if ( version_compare( WOOCOMMERCE_VERSION, "2.0.0" ) >= 0 ) {
		...
		if ( have_comments() ) :
			...
			echo '<p class="add_review"><a href="#review_form" class="inline sf-button sf-icon-reveal accent" data-toggle="modal" title="' . __( 'Add Your Review', 'woocommerce' ) . '"><i class="ss-write"></i><span class="text">' . $add_review_text . '</span></a></p>';
		...
		echo '</div><div id="review_form" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="review-modal" aria-hidden="true">';
